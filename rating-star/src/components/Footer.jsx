...
const Footer = () => {
  // outter div
  return (
    <div className="flex flex-col items-center gap-4 pl-[1.125rem] pr-[1.125rem] p-6  bg-[#222] lg:px-32 lg:py-6">
      <div className="flex flex-col items-start gap-14 self-stretch lg:footer-content-lg ">
        ...
        <div className="flex flex-col items-center gap-4 self-stretch lg:footer-subcontent-lg 2xl:footer-subcontent-2xl">
          ...
          <div className="flex justify-center items-center gap-2 pt-[0.4375rem] pb-[0.4375rem] px-2 h-[3.375rem] bg-white">
            <div className="text-[#222] font-['Poppins'] leading-5">
              Sing up now
            </div>
        ...
        <div className="flex flex-col items-center gap-4 self-stretch lg:footer-subcontent-lg 2xl:footer-subcontent-2xl">
          ...
          <div className="flex items-center gap-2 self-stretch pt-[0.4375rem] pb-[0.4375rem] px-2 h-[3.375rem] border border-[#e1e1e1] bg-white placeholder text-[#9f9f9f] font-['Poppins'] leading-5">
            Enter your email
          </div>
